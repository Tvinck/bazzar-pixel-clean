        ...
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    ...
                    <button
                        onClick={onClose}
                        className="absolute top-12 right-4 z-30 w-10 h-10 flex items-center justify-center text-white/60 hover:text-white bg-white/10 rounded-full backdrop-blur-md"
                    >
                        <X size={20} />
                    </button>

                    {/* Main Image Container */}
                    <div className="flex-1 relative w-full h-full flex items-center justify-center p-4 pt-16">
                        <motion.div
                    ...
                    <div className="bg-[#121212] rounded-t-[2rem] p-6 pb-10 relative z-10 border-t border-white/5">
